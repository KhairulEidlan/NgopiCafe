...
public class RvCategoryAdapter extends RecyclerView.Adapter<RvCategoryAdapter.RvCatHolder> {
    private Context context;
    private String username;
    private final ArrayList<RvCategory> category;
    int row_index = -1;

    public RvCategoryAdapter(Context context, String username, ArrayList<RvCategory> category) {
    ...
    @NonNull
    @Override
        public RvCategoryAdapter.RvCatHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.rv_app_category,parent,false);
    ...
    public void onBindViewHolder(@NonNull RvCatHolder holder, @SuppressLint("RecyclerView") int position) {
        RvCategory currentCat = category.get(position);
